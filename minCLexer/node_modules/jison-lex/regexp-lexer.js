...
RegExpLexer.prototype = {
    ...
    validateNumber: function validateNumber(number) {
        ...
        return (regexPattern.test(number) || number === '0') 
            ? {INTCONST: parseInt(number)} : this.validateInvalidToken(number);
    },
    ...
    validateInvalidToken: function validateInvalidToken(string) {
        ...
        if (string[0] === "'") {
            ...
            return "Minimal C does not allow leading 0s " + generateError(this.yylloc);
        }
        return {ILLEGAL_TOK: string + ' ' + generateError(this.yylloc)}
    },
