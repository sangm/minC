...
RegExpLexer.prototype = {
    ...
    validateInvalidToken: function validateInvalidToken(string) {
        if (string[0] === "'") {
            return "Unclosed quote on character Line: " + this.yylloc.first_line + " Column: " + this.yylloc.last_column;
        }
        else if (string[0] === '"') {
            return "Unterminated string at Line: " + this.yylloc.first_line + " Column: " + this.yylloc.last_column;
        }
    ...
    validateComment: function validateComment(comment) {
        ...
        if (validCommentPattern.test(comment)) {
            ...
            return "Unterminated comment Line: " + this.yylloc.first_line + " Column: " + this.yylloc.last_column;
        }
    }
};
